...
var setDynamicElementsHeights = function setDynamicElementsHeights() {
  (0, _jquery2.default)('.news-block').height((0, _jquery2.default)('.news-block').width());
  (0, _jquery2.default)('.catalog-img').height((0, _jquery2.default)('.catalog-img').width());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dom7_dist_dom7_modular__ = __webpack_require__(1);
/**
 * Swiper 4.0.6
